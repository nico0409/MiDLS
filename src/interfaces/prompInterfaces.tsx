...
export type StorageTypes = {
  ...
  StorageType: 'allObserve' | 'observeCard' | 'prompt' | 'emplid';
...
export type promptField={
 ...
 // DLHR_APS:{Field1:'DL_EQUIPEMENT_ID' ,field2:'DESCR'}
}
...
export interface objUseForm {
  ...
  acto?: string,
  accion?: string,
  InterupcionTarea?: string,
  RequiereAps?: string,
  NumAps?: string,
  RespAps?: string,
  cuasiAccidente?: string,
  masDetalles?: string,
  Action?: string,
  questProtecionP?: string,
  questProcedimientoT?: string,
  questHerrEquip?: string,
  questReaccionP?: string,
  questUbicacionP?: string,
  questControlP?: string,
  questOrdenL?: string,
  questmedioA?: string,
  goldRule1?: string,
  goldRule2?: string,
