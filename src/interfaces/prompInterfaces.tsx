...
export type StorageTypes = {
  ...
  StorageType: 'allObserve' | 'observeCard' | 'prompt' | 'emplid' | 'offlineObserveCards' | 'offlineObserveCardsDescr' | 'signInStatus' | 'lastDataUpdateDttm' | 'lastTObsUpdateDttm' | 'deviceId';
